...
The demokit *Code of Conduct* sets the rules for the behavior of
every member in the demokit community so that everyone can
...
demokit is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make demokit a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and demokit is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of demokit comes from its varied community
